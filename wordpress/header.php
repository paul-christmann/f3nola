        ...
        <div class="socialmedia">
          ...
          <div class="loginheader">
            <?php if (!is_user_logged_in() ) { ?>
              <span>
                <a href="http://www.f3nola.com/wp-login.php?action=register">FNG Signup</a> or
                <a href="http://www.f3nola.com/wp-login.php">Login</a>
              </span>
            <?php } else { ?>
              <span>
                <a href="http://www.f3nola.com/wp-login.php?action=logout">Logout</a>
              </span>
            <?php } ?>
          </div>
        </div>
